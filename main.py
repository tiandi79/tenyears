...
plt.barh(categories, values3, label='天龙人的结余', left=[v1+v2 for v1, v2 in zip(values1, values2)])
plt.barh(categories, values4, label='天龙人的生存成本', left=[v1+v2+v3 for v1, v2, v3 in zip(values1, values2, values3)])
